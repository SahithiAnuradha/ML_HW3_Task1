...
data = pd.read_csv(r'C:\Users\psahi\OneDrive\Desktop\ASSIGNMENT\ML\Kmean_data.csv')
labels = pd.read_csv(r'C:\Users\psahi\OneDrive\Desktop\ASSIGNMENT\ML\Kmean_label.csv')
